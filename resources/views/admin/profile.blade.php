...
<head>
    ...
    <style>
        ...
        .admin-stat-box:hover { transform: translateY(-3px); box-shadow: 0 4px 10px rgba(0,0,0,0.05); }
        .admin-stat-value { font-size: 2rem; font-weight: bold; color: var(--primary-bg); }
                ...
                <div class="card profile-card p-4">
                    ...
                    <div class="text-center mb-4">
                        <h3 class="fw-bold mb-1">
                            {{ $user->user_userName }}
                            <span class="badge bg-primary badge-custom align-middle">Administrator</span>
                        </h3>

                        <p class="text-muted mb-2">{{ $user->user_email }}</p>

                        <div class="mt-3">
                            <a href="{{ route('admin.edit') }}" class="btn btn-outline-primary rounded-pill px-4 fw-bold w-100">Edit Profile</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card content-card p-4">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="admin-stat-box">
                                    ...
                                    <div class="text-muted fw-bold">Total Users</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="admin-stat-box">
                                    <div class="admin-stat-value">{{ $platform_stats['total_artworks'] }}</div>
                                    <div class="text-muted fw-bold">Total Artworks</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="admin-stat-box">
                                    <div class="admin-stat-value">{{ $platform_stats['total_comments'] }}</div>
                                    <div class="text-muted fw-bold">Total Comments</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="your-art-content" style="display: none;">
                        <h5 class="fw-bold mb-3">Your Original Challenges</h5>
                        <div class="row g-3">
